      ...
      ActionListener printl = new ActionListener ()
                              {
                                  public void actionPerformed (ActionEvent e)
                                  {
                                     ...
                                     try
                                     {
                                         ...
                                         set.add (new Copies (3));
                                         // Except for set, all of the
                                         // arguments below are the default
                                         // arguments passed when you call the
                                         // no-argument print() method.
                                         ep.print (null, null, true, null,
                                                   set, true);
                                     }
